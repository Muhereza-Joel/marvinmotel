                        ...
                        <div>
                            ...
                            <div className="flex">
                                <input
                                    ...
                                    className="px-4 py-2 rounded-l-md border border-gray-600 bg-gray-800 text-gray-200 focus:outline-none focus:ring-1 focus:ring-orange-500 w-full"
                                />
                                <button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-r-md transition duration-200">
                                    Subscribe
                                </button>
                            </div>
                        </div>
